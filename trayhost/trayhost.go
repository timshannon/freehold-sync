...
#cgo linux CFLAGS: -I/usr/include/libappindicator3-0.1/
#cgo linux LDFLAGS: -L/usr/lib -lappindicator3
...
// EnterLoop Run the host system's event loop
...
// SetURL Set the URL that the tray icon will open in a browser
